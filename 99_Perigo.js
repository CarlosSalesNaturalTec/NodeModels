...
var db1 = "DROP DATABASE DB_Rastreadores";
...
con.connect(function (err) {
    ...
    con.query(db1, function (err, result) {
        if (err) { console.log("Erro ao tentar Excuir Banco de Dados. Detalhes: " + err); console.log(Fim); return; } else { console.log("Banco de Dados EXCLUIDO com sucesso."); console.log(Fim); }
    });
